...
export default function HeroAdmin() {
    ...
    const fetchData = async () => {
      try {
        ...
        const processChartData = () => {
          ...
          // Buat array kosong untuk semua tanggal di bulan ini (tgl 1 s/d 30/31)
          ...
          // Loop semua pasien dan hitung yang daftar di bulan ini
  ...
  return (
    <div className="flex-1 p-6 bg-[#f8f8f8] overflow-y-auto">
     {/* HEADER DALAM CARD */}
<div className="bg-[#b49b50] text-white p-6 rounded-2xl shadow-md mb-8">
